...
from RewardDataset import RewardCloneDataset
...
def evaluate(args, model, tokenizer):
    ...
    eval_dataset = RewardCloneDataset(tokenizer, args, args.eval_data_file)
...
def main():
    ...
    train_dataset = RewardCloneDataset(tokenizer, args, args.train_data_file)
