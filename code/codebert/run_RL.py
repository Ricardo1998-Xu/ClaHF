...
def train(args, train_dataset, model, ref_model, reward_model, tokenizer):
    ...
    for idx in range(args.start_epoch, int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(bar):
            ...
            rewards = compute_rewards(args, inputs, actions, reward_model, tokenizer, label_map)
...
def main():
    ...
    parser.add_argument('--num_labels', type=int, default=2,
                        help='class num')
    parser.add_argument("--train_data_file", default='../dataset/Devign/train.jsonl', type=str,
                        help="The input training data file (a text file).")
    parser.add_argument("--eval_data_file", default='../dataset/Devign/valid.jsonl', type=str,
