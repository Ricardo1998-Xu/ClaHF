...
from transformers import (OPTConfig, OPTForSequenceClassification, AutoTokenizer, OPTModel,
...
MODEL_CLASSES = {
    'opt': (OPTConfig, OPTForSequenceClassification, OPTModel, AutoTokenizer)
}
